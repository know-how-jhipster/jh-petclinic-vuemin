  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 id="petclinicApp.visits.home.createOrEditLabel" data-cy="VisitsCreateUpdateHeading">Create or edit a Visits</h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" for="visits-visitdate">Visitdate</label>
            <div class="d-flex">
              <input
                id="visits-visitdate"
                data-cy="visitdate"
            ...
            <div v-if="$v.visits.visitdate.$anyDirty && $v.visits.visitdate.$invalid">
              <small class="form-text text-danger" v-if="!$v.visits.visitdate.required"> This field is required. </small>
              <small class="form-text text-danger" v-if="!$v.visits.visitdate.ZonedDateTimelocal">
                This field should be a date and time.
              </small>
            </div>
          </div>
          <div class="form-group">
            <label class="form-control-label" for="visits-description">Description</label>
            <input
              type="text"
              class="form-control"
              name="description"
            ...
            <div v-if="$v.visits.description.$anyDirty && $v.visits.description.$invalid">
              <small class="form-text text-danger" v-if="!$v.visits.description.required"> This field is required. </small>
              <small class="form-text text-danger" v-if="!$v.visits.description.maxLength">
                This field cannot be longer than 255 characters.
              </small>
            </div>
          </div>
          <div class="form-group">
            <label class="form-control-label" for="visits-pet">Pet</label>
