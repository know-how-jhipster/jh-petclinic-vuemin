...
export default class Visits extends Vue {
  ...
  public retrieveAllVisitss(): void {
  ...
  public prepareRemove(instance: IVisits): void {
  ...
  public removeVisits(): void {
    this.visitsService()
      ...
      .then(() => {
        const message = 'A Visits is deleted with identifier ' + this.removeId;
