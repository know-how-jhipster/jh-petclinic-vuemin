  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 id="petclinicApp.pets.home.createOrEditLabel" data-cy="PetsCreateUpdateHeading">Create or edit a Pets</h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" for="pets-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
            ...
            <div v-if="$v.pets.name.$anyDirty && $v.pets.name.$invalid">
              <small class="form-text text-danger" v-if="!$v.pets.name.required"> This field is required. </small>
              <small class="form-text text-danger" v-if="!$v.pets.name.maxLength"> This field cannot be longer than 32 characters. </small>
            </div>
          </div>
          <div class="form-group">
            <label class="form-control-label" for="pets-birthdate">Birthdate</label>
            ...
            <div v-if="$v.pets.birthdate.$anyDirty && $v.pets.birthdate.$invalid">
              <small class="form-text text-danger" v-if="!$v.pets.birthdate.required"> This field is required. </small>
            </div>
          </div>
          <div class="form-group">
            <label class="form-control-label" for="pets-type">Type</label>
          ...
          <div class="form-group">
            <label class="form-control-label" for="pets-owner">Owner</label>
