...
export default class Pets extends mixins(JhiDataUtils) {
  ...
  public prepareRemove(instance: IPets): void {
  ...
  public removePets(): void {
    this.petsService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A Pets is deleted with identifier ' + this.removeId;
