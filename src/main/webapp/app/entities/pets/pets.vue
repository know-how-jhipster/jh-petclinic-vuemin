<template>
  <div>
    <h2 id="page-heading" data-cy="PetsHeading">
      <span id="pets-heading">Pets</span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="petclinicApp.pets.delete.question" data-cy="petsDeleteDialogHeading">Confirm delete operation</span></span
      >
      <div class="modal-body">
        <p id="jhi-delete-pets-heading">Are you sure you want to delete this Pets?</p>
      </div>
