<template>
  <div>
    <h2 id="page-heading" data-cy="SpecialtiesHeading">
      <span id="specialties-heading">Specialties</span>
      <div class="d-flex justify-content-end">
        ...
        <router-link :to="{ name: 'SpecialtiesCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span> Create a new Specialties </span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="petclinicApp.specialties.delete.question" data-cy="specialtiesDeleteDialogHeading">Confirm delete operation</span></span
      >
      <div class="modal-body">
        <p id="jhi-delete-specialties-heading">Are you sure you want to delete this Specialties?</p>
      </div>
