<template>
  <div>
    <h2 id="page-heading" data-cy="OwnersHeading">
      <span id="owners-heading">Owners</span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="petclinicApp.owners.delete.question" data-cy="ownersDeleteDialogHeading">Confirm delete operation</span></span
      >
      <div class="modal-body">
        <p id="jhi-delete-owners-heading">Are you sure you want to delete this Owners?</p>
      </div>
